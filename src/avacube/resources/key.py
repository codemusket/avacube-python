...
class KeyResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> KeyResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/avacube-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> KeyResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/avacube-python#with_streaming_response
        """
